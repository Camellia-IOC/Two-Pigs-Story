                ...
                <div class="register-panel"
                    ...
                    <div class="button-area">
                        <el-button class="btn-main" type="primary" @click="handleRegisterRequest"
                            :disabled="registerPermission">注册</el-button>
                ...
                <div class="login-panel"
                        ...
                        <div style="display: flex;justify-content:space-between;align-items: center;width: 15vw;">
                            <el-form-item prop="remember">
                                <el-checkbox v-model="loginRuleForm.remember"
                                    style="margin-right: 10px;">记住密码</el-checkbox>
                            </el-form-item>
                            <el-form-item>
                    ...
                    <div class="button-area">
                        <el-button class="btn-main" type="primary" @click="handleLoginRequest"
                            :disabled="loginPermission">登录</el-button>
...
<script setup lang="ts">
    ...
    import loginRequest from '@/api/modules/loginApi';
    ...
    const loginPermission = computed(() => {
        if (loginRuleForm.value.id && loginRuleForm.value.password) {
            return false;
        }
        else {
            return true;
    ...
    const registerPermission = computed(() => {
        if (registerRuleForm.value.username != '' && registerRuleForm.value.password != '' && registerRuleForm.value.check != '' && (registerRuleForm.value.password == registerRuleForm.value.check)) {
            return false;
        }
        else {
            return true;
