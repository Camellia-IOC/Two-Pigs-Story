...
class CardSpreadPosition
{
    ...
    init(e = null)
    {
        e &&
            ((this.element = e.element || this.element),
                ...
                (e.rangeAngle || 0 == e.rangeAngle) && (this.rangeAngle = e.rangeAngle),
    ...
    addHtml()
    {
        ; (this.elems = document.querySelectorAll(this.element)), this.style(), this.spread();
    }
    spread(e = !1)
    {
        ...
        this.elems.forEach((t) =>
        {
            ...
            )
            {
                ...
                if ((t.style.setProperty('--card-angle', Math.round(e) + 'deg'), this.randomOrder))
                {
    ...
    reset()
    {
        ...
        {
            e.style.setProperty('--card-x', '0px'), e.style.setProperty('--card-y', '0px');
        });
    }
    resize()
    {
