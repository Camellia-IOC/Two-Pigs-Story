<template>
    <div class="puzzle-container">
        <svg class="puzzle" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 285 200">
            ...
            <defs>
                <pattern id="img" patternUnits="userSpaceOnUse" width="125" height="100">
                    <image id="imgSrc" href="" width="125" height="100" preserveAspectRatio="xMidYMid slice" />
                </pattern>
                <filter id="bevel" filterUnits="objectBoundingBox">
                    <feGaussianBlur in="SourceAlpha" stdDeviation="0.9" result="blur" />
                    <feSpecularLighting in="blur" surfaceScale="0.8" specularConstant="1" specularExponent="2"
...
<script lang="ts" setup>
    ...
    function puzzleInit() {
        ...
        const kittens = [
            '/images/picture_heart_images/1-1.jpg',
            '/images/picture_heart_images/1-2.jpg',
            '/images/picture_heart_images/2-1.jpg',
            '/images/picture_heart_images/2-2.jpg',
            '/images/picture_heart_images/3-1.jpg',
            '/images/picture_heart_images/3-2.jpg',
            '/images/picture_heart_images/4-1.jpg',
            '/images/picture_heart_images/4-2.jpg',
            '/images/picture_heart_images/5-1.jpg',
            '/images/picture_heart_images/5-2.jpg',
            '/images/picture_heart_images/6-1.jpg',
            '/images/picture_heart_images/6-2.jpg',
            '/images/picture_heart_images/7-1.jpg',
            '/images/picture_heart_images/7-2.jpg',
            '/images/picture_heart_images/8-1.jpg',
            '/images/picture_heart_images/8-2.jpg',
        ]
        const startPos = [
            { x: 164, y: 56 },
            { x: 77, y: -35 },
            ...
            Draggable.create(piece, {
                ...
                onRelease: () => {
                    gsap
                        ...
                        .add(check)
                    if (
                        Math.abs(gsap.getProperty(piece, 'x') as number) < 9 &&
                        Math.abs(gsap.getProperty(piece, 'y') as number) < 9
                    ) {
        ...
        function check() {
            ...
            document.querySelectorAll('.piece').forEach((p) => {
                n += Math.abs(gsap.getProperty(p, 'x') as number)
                n += Math.abs(gsap.getProperty(p, 'y') as number)
            })
            if (n < 1) {
                if (puzzle != null && endImg != null) {
        ...
        gsap.set('.puzzle-container', { background: 'hsl(' + 'random(0,360)' + ', 70%, 80%)' })
        gsap.set('#imgSrc', {
            attr: {
